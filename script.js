...
document.querySelector("#page2>h1").textContent.split(" ").forEach(
  (dets) => {
...
document.querySelector("#page4>h1").textContent.split(" ").forEach(
  (dets) => {
...
document.querySelector("#page6>h1").textContent.split(" ").forEach(
  (dets) => {
